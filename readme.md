...
##不具合について  
iframe広告ブロックをONにしているとyoutubeなどの埋め込み動画が非表示になる不具合がありますが、次のアップデートで修正されます  
...
(09/29追記)    
次のアップデートで300以上の広告配信ネットワークをボタン一つでブロックする機能が追加されるので、ドメイン指定リストのダウンロードは廃止されました。  
アップデートが配信されるまで1週間ほどかかりますのでお待ち下さい。  
